...
jsPsych.plugins['free-sort'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < 2; i++) {
      var coords_x = 0;
      coords_x = coords_x + (trial.sort_area_width - trial.stim_width)*i
      var coords_y = 300;
      ...
      display_element.querySelector("#jspsych-free-sort-arena").innerHTML += '<img '+
        ...
        'draggable="false" '+
        'style="position: absolute; cursor: move; width:'+trial.stim_width+'px; height:'+trial.stim_height+'px; top:'+coords_y+'px; left:'+coords_x+'px;">'+
        '</img>';
    ...
    display_element.querySelector("#jspsych-free-sort-arena").innerHTML += '<img src="img/SmileyScale.png" width=130></img>';
